...
# =============================================
with st.sidebar:
    st.image("https://e7.pngegg.com/pngimages/680/777/png-clipart-fruits-and-veggies-vegetable-eating-food-vegetable-natural-foods-food.png" witdh=80 layout="centered")
